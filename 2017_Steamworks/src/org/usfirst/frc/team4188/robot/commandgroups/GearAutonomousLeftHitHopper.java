 ...
 *
 */
public class GearAutonomousLeftHitHopper extends CommandGroup {

    public GearAutonomousLeftHitHopper() {
        // Add Commands here:
...
//    	addSequential(new DriveStraightToDistance((Robot.driveAwayFromPegDistance/12.0), 0.9));
    	
    	addSequential(new AimHighGoal(Robot.turnAwayFromGoalAngle));
