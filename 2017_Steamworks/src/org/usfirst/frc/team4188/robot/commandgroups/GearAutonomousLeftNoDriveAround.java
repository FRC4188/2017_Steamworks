 ...
 *
 */
public class GearAutonomousLeftNoDriveAround extends CommandGroup {

    public GearAutonomousLeftNoDriveAround() {
        // Add Commands here:
        ...
        // arm.
    	addSequential(new DriveStraightToDistance((71.0/12.0), 0.75));
