 ...
 *
 */
public class EncoderTurnToAngleRight extends Command {
    ...
    double distance;
    double speed;
	public EncoderTurnToAngleRight(double distance, double speed) {
    ...
    protected void initialize() {
    	...
    	CHSRobotDrive.setPIDType(PIDType.turnToAngleRight);
